<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo"> <a href="/"> <img src="imagenes/form_LogReg/logo.jpg" alt="logo"
                    style="width:4rem; height:4rem;"> </a> {{-- <x-jet-authentication-card-logo /> --}} </x-slot>
        <form method="POST" action="{{ route('register') }}"> @csrf <div class="mt-4">
                <x-jet-label for="rol_id" value="{{ __('Registrarme Como:') }}" /> <select id="rol_id"
