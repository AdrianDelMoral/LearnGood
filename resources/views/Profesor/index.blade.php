...
@section('cuerpo')
                ...
                <div class="row justify-content-evenly mb-5 pb-5">
                            ...
                            <div class="cajaImg_profesor">
                                <div
                                    ...
                                    <img class="rounded-circle img-fluid overflow-hidden"
                                        src="{{ $user->profile_photo_url }}" alt="{{ $user->role_id }}" width="150px"
                                        height="150px" />
                                </div>
                            </div>
                    ...
                    <div class="col-md-10 container">
                        <div class="p-3 py-5">
                            ...
                            <div
                                class="justify-content-center row row-cols-1 row-cols-md-3 mb-3 text-center align-items-center">
    ...
    <div class="d-flex flex-wrap justify-content-center">
        <a href="/">
            <button class="btn btn-lg btn-primary my-5">Volver a Inicio</button>
        </a>
    </div>
@endsection
