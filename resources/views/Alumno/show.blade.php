...
@section('cuerpo')
                ...
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <div class="cajaImg_profesor"
                        ...
                        <div
                            ...
                            <img class="rounded-circle img-fluid overflow-hidden" src="{{ $profeInfo->profile_photo_url }}"
                                alt="{{ $profeInfo->role_id }}" width="150px" height="150px" />
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-dark text-light m-3">
                            <div class="m-4">
                                <p class="card-caption h4 text-red text-center">
                                    Este profesor aun no tiene precios
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-md-10 container">
        <div class="text-center">
            <div class="my-5 mb-4">
                <h1 class="display-4 fw-normal">Niveles del Idioma</h1>
            </div>
        </div>
        <div class="row justify-content-center">
            @if ($profeInfo->subjects === null)
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-dark text-light m-3">
                        <div class="m-4">
                            <p class="card-caption h4 text-red text-center">
                                Este profesor aun no no tiene asignaturas
                            </p>
                        </div>
                    </div>
                </div>
            @else
                @foreach ($profeInfo->subjects as $subject)
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-dark text-light m-3">
                            <div class="m-4">
