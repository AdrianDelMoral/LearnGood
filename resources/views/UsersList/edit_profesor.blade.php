    ...
    <div class="container py-5 text-center">
        ...
        <form action="{{ route('manageusers.update', $id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="descripcion" id="descripcion" placeholder="Nombre"
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="idioma" id="idioma" placeholder="Nombre"
                    value="{{ old('idioma') ?? @$user->idioma }}">
                @error('idioma')
                    <p class="form-text text-danger">{{ $message }}</p>
                @enderror
            </div>
